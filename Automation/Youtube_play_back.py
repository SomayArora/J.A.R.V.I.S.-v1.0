...
def perform_media_action(text):
    if "volume up" in text or "volume badhao" in text:
        ...
        volume_down()
    elif "seek forward" in text or "aage karo" in text:
        seek_forward()
    elif "seek backward" in text or "peeche karo" in text:
        seek_backward()
    elif "seek forward 10 seconds" in text or "10 second aage karo" in text:
        seek_forward_10s()
        ...
        seek_backward_frame()
    elif "seek forward frame" in text or "frame aage karo" in text:
        seek_forward_frame()
    elif "seek to beginning" in text or "start par jao" in text:
        seek_to_beginning()
